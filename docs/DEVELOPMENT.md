...
> Release 0.3.1 is withdrawn and 0.3.2 is historical context. The current release line is 0.3.6 and its exact installer and Linux archive must be generated by GitHub Actions and tested before promotion.
