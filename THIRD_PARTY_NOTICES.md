...
| 组件 | 用途 | 来源 | 许可证 |
| --- | --- | --- | --- |
| mihomo | 代理核心；基于上游 v1.19.30 的固定版本包含 Tailnet 入站转发 | https://github.com/lumokato/MeshMux/releases/tag/mihomo-v1.19.30-meshmux.1 | GPL-3.0 |
...
Mihomo 的固定核心 Release 同时提供二进制和对应完整源码包，并记录上游提交与构建参数。
